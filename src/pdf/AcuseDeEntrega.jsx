    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.guaranteeTable}>
          <Text style={styles.guaranteeBox}>Garantía</Text>
          <Text style={styles.blankField}>{''}</Text>
          <Text style={styles.guaranteeBox}>Meses</Text>
        </View>
        ...
        <View style={styles.observations}>
          ...
          <Text style={styles.observationsText}>• En caso de entregar el equipo con algún daño físico o de hardware ya sea al ultrasonido y/o transductores, se le hace responsable a la persona que recibió el mismo.</Text>
        </View>
